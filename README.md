...
- **Palavra única por dia** - baseada em uma lista fixa, com rodízio diário.
- **Apenas uma chance** - se errar, o jogo bloqueia e você nunca mais poderá jogar neste dispositivo.
...
1. Acesse o jogo.
2. Digite uma palavra de 5 letras (use o teclado virtual ou o teclado físico).
3. Pressione **ENTER** para enviar sua tentativa.
4. As cores vão te mostrar o quão perto você chegou:
...
### Tela inicial
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/55a7df16-63f2-4219-b865-65d3e3291a0a" />

### Durante o jogo
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/c8030b0f-725a-4fcf-9581-dba953b39d4f" />

### Paleta de cores (exemplo)

Paleta de cores roxa
<img width="1917" height="1079" alt="image" src="https://github.com/user-attachments/assets/7b4428f8-8fe5-408c-a1f2-06fece851bd8" />

Paleta de cores verde
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/56143618-6110-4f1f-8beb-ff0cb0b4bb96" />
